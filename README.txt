...
- MadsAssortedAdjustmentsConfig.cs: Example of ModConfig for custom mod settings;
- MadsAssortedAdjustmentsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- MadsAssortedAdjustmentsMain.cs: Main mod class, recieves mod management and general events;
- MadsAssortedAdjustmentsTactical.cs: Example of ModTactical for modifying tactical level;
