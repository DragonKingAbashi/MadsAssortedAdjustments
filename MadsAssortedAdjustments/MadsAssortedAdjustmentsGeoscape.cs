...
namespace MadsAssortedAdjustments
{
	...
	public class MadsAssortedAdjustmentsGSInstanceData
	{
	...
	/// </summary>
	public class MadsAssortedAdjustmentsGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new MadsAssortedAdjustmentsGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			MadsAssortedAdjustmentsGSInstanceData data = (MadsAssortedAdjustmentsGSInstanceData)instanceData;
		}
