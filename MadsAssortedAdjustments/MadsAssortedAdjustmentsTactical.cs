...
namespace MadsAssortedAdjustments
{
	...
	public class MadsAssortedAdjustmentsTacInstanceData
	{
	...
	/// </summary>
	public class MadsAssortedAdjustmentsTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			MadsAssortedAdjustmentsMain main = (MadsAssortedAdjustmentsMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			MadsAssortedAdjustmentsTacInstanceData data = (MadsAssortedAdjustmentsTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new MadsAssortedAdjustmentsTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
