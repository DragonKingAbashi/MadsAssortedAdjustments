...
namespace MadsAssortedAdjustments
{
    internal static class UnlockItemsByResearch
    {
        ...
        public static void Init()
        {
            ...
            UnlockConfiguration PromoArmor = new UnlockConfiguration("PromoArmor")
            {
            ...
            UnlockConfiguration HiddenItems = new UnlockConfiguration("HiddenItems")
            {
                UnlockableItemDefs = new List<string>()
                {
                    "PX_PhoenixProject_ResearchDef",
            ...
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockPhoenixEliteGear)
            {
                UnlockConfigurations.Add(PhoenixEliteGear);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockLivingWeapons)
            {
                UnlockConfigurations.Add(LivingWeapons);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockLivingArmor)
            {
                UnlockConfigurations.Add(LivingArmor);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockIndependentAmmunition)
            {
                UnlockConfigurations.Add(IndependentAmmunition);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockIndependentWeapons)
            {
                UnlockConfigurations.Add(IndependentWeapons);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockIndependentArmor)
            {
                UnlockConfigurations.Add(IndependentArmor);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockPromoArmor)
            {
                UnlockConfigurations.Add(PromoArmor);
            }
            if (AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockHiddenItems)
            {
                UnlockConfigurations.Add(HiddenItems);
            }
        }
        ...
        */
        ...
        public static class Research_Initialize_Patch
        {
            ...
            {
                return AssortedAdjustments.MadsAssortedAdjustmentsConfig.UnlockItemsByResearch;
            }
