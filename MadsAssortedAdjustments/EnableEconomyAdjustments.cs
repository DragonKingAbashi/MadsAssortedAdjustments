    ...
    internal static class EconomyAdjustments
    {
        public static void Apply()
        {
            ...
            foreach (ItemDef iDef in allItemDefs)
            {
                ...
                float resourceMultiplier = AssortedAdjustments.MadsAssortedAdjustmentsConfig.ResourceMultiplier;
                float costMultiplier = AssortedAdjustments.MadsAssortedAdjustmentsConfig.CostMultiplier;
        ...
        public static void Postfix_ItemDef_ScrapPrice(ItemDef __instance, ref ResourcePack __result, ResourcePack ____scrapPrice)
        {
            try
            {
                float scrapMultiplier = AssortedAdjustments.MadsAssortedAdjustmentsConfig.ScrapMultiplier;
